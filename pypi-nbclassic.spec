...
Source0  : https://files.pythonhosted.org/packages/09/61/3bcba7461c2956d7f39e407cfa524c2110b2f6a597f40d97a0d5e365df5e/nbclassic-0.4.6.tar.gz
...
%prep
%setup -q -n nbclassic-0.4.6
cd %{_builddir}/nbclassic-0.4.6
pushd ..
cp -a nbclassic-0.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665600439

...
Source0  : https://files.pythonhosted.org/packages/a3/da/35f31f63d0bb6bec9e1e631ce3664ab99c135951a2a713708577f6ba8f80/nbclassic-0.4.4.tar.gz
...
%prep
%setup -q -n nbclassic-0.4.4
cd %{_builddir}/nbclassic-0.4.4
pushd ..
cp -a nbclassic-0.4.4 buildavx2
popd

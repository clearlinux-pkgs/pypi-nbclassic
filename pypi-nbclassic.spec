...
%prep
%setup -q -n nbclassic-0.3.7
cd %{_builddir}/nbclassic-0.3.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649606853
...
cp %{_builddir}/nbclassic-0.3.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2

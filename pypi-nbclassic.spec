...
Source0  : https://files.pythonhosted.org/packages/2c/82/047ae6a037bfacaa2e2f2bda725b156aabc45609bd69a47fe9d1ff5d0328/nbclassic-0.3.5.tar.gz
...
%prep
%setup -q -n nbclassic-0.3.5
cd %{_builddir}/nbclassic-0.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642006162
...
cp %{_builddir}/nbclassic-0.3.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2

...
Version  : 0.4.5
Release  : 29
URL      : https://files.pythonhosted.org/packages/87/53/f772db447e5da12433f7bd5bf71b71e7eb15f465c22087fc9a5e027bab59/nbclassic-0.4.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/87/53/f772db447e5da12433f7bd5bf71b71e7eb15f465c22087fc9a5e027bab59/nbclassic-0.4.5.tar.gz
...
%prep
%setup -q -n nbclassic-0.4.5
cd %{_builddir}/nbclassic-0.4.5
pushd ..
cp -a nbclassic-0.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665419691

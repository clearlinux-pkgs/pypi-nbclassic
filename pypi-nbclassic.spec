...
Source0  : https://files.pythonhosted.org/packages/0f/20/194d1bf71e09bb42ba7f11e5d0786af314b76aeca67b3bd1f44e572630f1/nbclassic-1.2.0.tar.gz
...
%prep
%setup -q -n nbclassic-1.2.0
cd %{_builddir}/nbclassic-1.2.0
pushd ..
cp -a nbclassic-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736947889

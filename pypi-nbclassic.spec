...
Source0  : https://files.pythonhosted.org/packages/e9/09/5b7fefee81982434d603813cf6059d5b3050a5eb8953290f58ec6c12bd56/nbclassic-0.5.3.tar.gz
...
%prep
%setup -q -n nbclassic-0.5.3
cd %{_builddir}/nbclassic-0.5.3
pushd ..
cp -a nbclassic-0.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678118911

...
Source0  : https://files.pythonhosted.org/packages/ba/a1/d6e92354cb3f198bd113f8d9945d3b55b22b9405fa9a145582b0d37f8fba/nbclassic-0.5.1.tar.gz
...
%prep
%setup -q -n nbclassic-0.5.1
cd %{_builddir}/nbclassic-0.5.1
pushd ..
cp -a nbclassic-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674835070

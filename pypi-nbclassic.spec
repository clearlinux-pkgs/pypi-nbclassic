...
Source0  : https://files.pythonhosted.org/packages/ae/5a/6bdc0b20e5f6894fef0be99e0a9132bd8467fd082164fdbdbd37464416f6/nbclassic-0.4.7.tar.gz
...
%prep
%setup -q -n nbclassic-0.4.7
cd %{_builddir}/nbclassic-0.4.7
pushd ..
cp -a nbclassic-0.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666279870
